---
title: Overview
description: "The dashboard home — KPIs, trends, and a live trace feed."
---
...
- **Cost over time** — a stacked area chart of cost per minute, split by model.
...
The **Live feed** card streams the latest traces as they arrive, refreshing
every few seconds. Click any row to open its [trace](/dashboard/traces). Before
your first span lands, an onboarding panel appears here instead — it disappears
